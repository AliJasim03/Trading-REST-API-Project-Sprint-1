    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <div className="mb-8">
                ...
                <p className="text-gray-600">Check the status and details of your orders</p>
            </div>

            {/* Search Section */}
            <Card className="p-6 mb-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Search Order</h2>
            ...
            {orderData && (
                <>
                    ...
                    <Card className="p-6 mb-6 border-l-4 border-l-primary-500">
                        ...
                        <p className="text-gray-600">{getStatusMessage(orderData.status_code)}</p>
                    </Card>
                        ...
                        <Card className="p-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                    ...
                                    <span className="font-medium text-lg">#{orderData.orderId}</span>
                                </div>
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    {orderData.buy_or_sell}
                                ...
                                <div className="flex justify-between items-center py-2">
                                    ...
                                    <span className="font-medium">{orderData.order_type || 'N/A'}</span>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                    ...
                                    <span className="font-medium">${orderData.price?.toFixed(2) || '0.00'}</span>
                                </div>
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                    <span className="text-gray-600">Volume:</span>
                                    <span className="font-medium">{orderData.volume || 0} shares</span>
                                </div>
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    ${((orderData.price || 0) * (orderData.volume || 0)).toFixed(2)}
                                ...
                                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                                    ...
                                    <span className="font-medium">${orderData.fees?.toFixed(2) || '0.00'}</span>
                                </div>
                    ...
                    <Card className="p-6">
                        ...
                        <div className="relative">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <div className="w-4 h-4 bg-primary-600 rounded-full border-2 border-white shadow"></div>
                                    <div className="ml-4">
                                ...
                                <div className="flex items-center">
                                    <div className={`w-4 h-4 rounded-full border-2 border-white shadow ${
                                        orderData.status_code >= 1 ? 'bg-primary-600' : 'bg-gray-300'
                                    }`}></div>
                                    <div className="ml-4">
